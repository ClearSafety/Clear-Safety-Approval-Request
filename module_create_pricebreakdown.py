...
def create_PriceBreakdownGroup(
    ...
    def dropdown_onchange(e):
        ...
        try: 
            _sorprice.value = f"£{list(filter(lambda item: item.get('SOR Code') == pricebreakdown.controls[0].value, field_option_source))[0].get(field_column_price):.2f}"
        except:
            _sorprice.value=None
...
if __name__ == '__main__':
    ...
    sorcode = [
        {'SOR Code': '789', 'SOR Description': 'EITA', 'Price': 150},
        {'SOR Code': '123', 'SOR Description': 'DO IT', 'Price': 50},
        {'SOR Code': '456', 'SOR Description': 'DO THAT', 'Price': 100}
